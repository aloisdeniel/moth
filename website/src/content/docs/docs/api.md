---
title: API reference
description: The three gRPC surfaces, the token claims contract, JWKS verification, and introspection.
---
...
| [`moth.server.v1`](#mothserverv1) | secret key — `x-moth-key: sk_…` | your own backend |
