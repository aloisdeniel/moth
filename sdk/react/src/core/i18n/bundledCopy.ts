// GENERATED by scripts/port-bundled-copy.mjs from the Flutter SDK's
...
export const mothBundledLocales: readonly string[] = ["en","fr","de","es","pt","it","ja"]
...
const bundled: Record<string, Record<string, string>> = {
  "en": {
    ...
    "sign_in.config_error_body": "Sign-in options could not be loaded. Check your connection and try again.",
    ...
    "sign_up.verify_sent": "Account created — check your inbox to verify your email address, then sign in.",
    "password_reset.title": "Reset password",
    "password_reset.subtitle": "Enter your email and we'll send you a reset link.",
    "password_reset.email_label": "Email",
    "password_reset.submit": "Send reset link",
    "password_reset.back_to_sign_in": "Back to sign in",
    "password_reset.sent": "If an account exists for {email}, a reset link is on its way.",
    ...
    "paywall.empty_body": "There are no subscriptions available right now. Check back later.",
    "paywall.error_title": "Cannot reach the store",
    "paywall.error_body": "Subscription options could not be loaded. Check your connection and try again.",
    "paywall.retry": "Try again",
    "paywall.purchase_pending": "Your purchase is pending approval. It will unlock once confirmed.",
    "paywall.already_owned": "You already own this subscription — tap Restore to re-link it.",
    ...
    "error.email_not_verified": "Please verify your email address first — check your inbox.",
    ...
    "error.provider_disabled": "This sign-in method is not enabled for this app.",
    "error.provider_failed": "Sign-in with the provider failed. Please try again.",
    "error.last_login_method": "This is your only way to sign in, so it cannot be removed.",
    "error.network": "Cannot reach the server. Check your connection and try again.",
    "error.generic": "Something went wrong. Please try again.",
    "paywall.unavailable_web": "Not available for purchase on the web"
  },
  "fr": {
    ...
    "sign_in.config_error_body": "Les options de connexion n'ont pas pu être chargées. Vérifiez votre connexion et réessayez.",
    ...
    "sign_up.legal": "En continuant, vous acceptez nos conditions d'utilisation et notre politique de confidentialité.",
    ...
    "sign_up.verify_sent": "Compte créé — consultez votre boîte de réception pour vérifier votre adresse e-mail, puis connectez-vous.",
    "password_reset.title": "Réinitialiser le mot de passe",
    "password_reset.subtitle": "Saisissez votre e-mail et nous vous enverrons un lien de réinitialisation.",
    ...
    "password_reset.sent": "Si un compte existe pour {email}, un lien de réinitialisation est en route.",
    ...
    "paywall.terms": "Le paiement est débité de votre compte. Annulez à tout moment.",
    ...
    "paywall.empty_body": "Aucun abonnement n'est disponible pour le moment. Revenez plus tard.",
    "paywall.error_title": "Impossible de joindre la boutique",
    "paywall.error_body": "Les options d'abonnement n'ont pas pu être chargées. Vérifiez votre connexion et réessayez.",
    "paywall.retry": "Réessayer",
    "paywall.purchase_pending": "Votre achat est en attente d'approbation. Il sera débloqué une fois confirmé.",
    "paywall.already_owned": "Vous possédez déjà cet abonnement — appuyez sur Restaurer pour le réassocier.",
    ...
    "error.email_not_verified": "Veuillez d'abord vérifier votre adresse e-mail — consultez votre boîte de réception.",
    "error.signup_closed": "Les inscriptions sont actuellement fermées pour cette application.",
    ...
    "error.provider_disabled": "Cette méthode de connexion n'est pas activée pour cette application.",
    "error.provider_failed": "La connexion avec le fournisseur a échoué. Veuillez réessayer.",
    "error.last_login_method": "C'est votre seul moyen de connexion, il ne peut donc pas être supprimé.",
    ...
    "paywall.unavailable_web": "Indisponible à l'achat sur le web"
  },
  "de": {
    ...
    "sign_in.config_error_body": "Die Anmeldeoptionen konnten nicht geladen werden. Überprüfe deine Verbindung und versuche es erneut.",
    ...
    "sign_up.legal": "Wenn du fortfährst, stimmst du unseren Nutzungsbedingungen und der Datenschutzerklärung zu.",
    "sign_up.error_email_taken": "Ein Konto mit dieser E-Mail existiert bereits.",
    "sign_up.password_too_short": "Verwende mindestens {count} Zeichen",
    "sign_up.verify_sent": "Konto erstellt — überprüfe dein Postfach, um deine E-Mail-Adresse zu bestätigen, und melde dich dann an.",
    "password_reset.title": "Passwort zurücksetzen",
    "password_reset.subtitle": "Gib deine E-Mail-Adresse ein und wir senden dir einen Link zum Zurücksetzen.",
    "password_reset.email_label": "E-Mail",
    "password_reset.submit": "Link senden",
    "password_reset.back_to_sign_in": "Zurück zur Anmeldung",
    "password_reset.sent": "Wenn ein Konto für {email} existiert, ist ein Link zum Zurücksetzen unterwegs.",
    ...
    "paywall.terms": "Die Zahlung wird deinem Konto belastet. Jederzeit kündbar.",
    ...
    "paywall.empty_body": "Derzeit sind keine Abos verfügbar. Schau später noch einmal vorbei.",
    "paywall.error_title": "Store nicht erreichbar",
    "paywall.error_body": "Die Abo-Optionen konnten nicht geladen werden. Überprüfe deine Verbindung und versuche es erneut.",
    "paywall.retry": "Erneut versuchen",
    "paywall.purchase_pending": "Dein Kauf wartet auf Bestätigung. Er wird freigeschaltet, sobald er bestätigt ist.",
    "paywall.already_owned": "Du besitzt dieses Abo bereits — tippe auf Wiederherstellen, um es erneut zu verknüpfen.",
    "paywall.restore_none": "Es wurden keine früheren Käufe zum Wiederherstellen gefunden.",
    "paywall.restore_done": "Deine Käufe wurden wiederhergestellt.",
    "paywall.restore_failed": "Käufe konnten nicht wiederhergestellt werden: {error}",
    "error.email_not_verified": "Bitte bestätige zuerst deine E-Mail-Adresse — überprüfe dein Postfach.",
    "error.signup_closed": "Die Registrierung ist für diese App derzeit geschlossen.",
    "error.invalid_email": "Diese E-Mail-Adresse sieht nicht richtig aus.",
    "error.session_expired": "Deine Sitzung ist abgelaufen — melde dich erneut an.",
    "error.user_disabled": "Dieses Konto wurde deaktiviert.",
    "error.rate_limited": "Zu viele Versuche — warte einen Moment und versuche es erneut.",
    "error.provider_disabled": "Diese Anmeldemethode ist für diese App nicht aktiviert.",
    "error.provider_failed": "Die Anmeldung beim Anbieter ist fehlgeschlagen. Bitte versuche es erneut.",
    "error.last_login_method": "Dies ist deine einzige Anmeldemethode und kann daher nicht entfernt werden.",
    "error.network": "Server nicht erreichbar. Überprüfe deine Verbindung und versuche es erneut.",
    "error.generic": "Etwas ist schiefgelaufen. Bitte versuche es erneut.",
    "paywall.unavailable_web": "Im Web nicht erhältlich"
  },
  "es": {
    ...
    "sign_in.config_error_body": "No se pudieron cargar las opciones de inicio de sesión. Comprueba tu conexión e inténtalo de nuevo.",
    ...
    "sign_up.legal": "Al continuar, aceptas nuestros términos y nuestra política de privacidad.",
    "sign_up.error_email_taken": "Ya existe una cuenta con este correo.",
    "sign_up.password_too_short": "Usa al menos {count} caracteres",
    "sign_up.verify_sent": "Cuenta creada: revisa tu bandeja de entrada para verificar tu correo electrónico y luego inicia sesión.",
    "password_reset.title": "Restablecer contraseña",
    "password_reset.subtitle": "Introduce tu correo y te enviaremos un enlace para restablecerla.",
    ...
    "password_reset.sent": "Si existe una cuenta para {email}, un enlace de restablecimiento está en camino.",
    ...
    "paywall.empty_body": "No hay suscripciones disponibles en este momento. Vuelve más tarde.",
    "paywall.error_title": "No se puede conectar con la tienda",
    "paywall.error_body": "No se pudieron cargar las opciones de suscripción. Comprueba tu conexión e inténtalo de nuevo.",
    "paywall.retry": "Reintentar",
    "paywall.purchase_pending": "Tu compra está pendiente de aprobación. Se desbloqueará una vez confirmada.",
    "paywall.already_owned": "Ya tienes esta suscripción: toca Restaurar para volver a vincularla.",
    "paywall.restore_none": "No se encontraron compras anteriores para restaurar.",
    "paywall.restore_done": "Tus compras se han restaurado.",
    "paywall.restore_failed": "No se pudieron restaurar las compras: {error}",
    "error.email_not_verified": "Verifica primero tu correo electrónico: revisa tu bandeja de entrada.",
    "error.signup_closed": "El registro está cerrado actualmente para esta aplicación.",
    ...
    "error.rate_limited": "Demasiados intentos: espera un momento e inténtalo de nuevo.",
    "error.provider_disabled": "Este método de inicio de sesión no está habilitado para esta aplicación.",
    "error.provider_failed": "El inicio de sesión con el proveedor falló. Inténtalo de nuevo.",
    "error.last_login_method": "Es tu única forma de iniciar sesión, así que no se puede eliminar.",
    ...
    "paywall.unavailable_web": "No disponible para comprar en la web"
  },
  "pt": {
    ...
    "sign_in.config_error_body": "Não foi possível carregar as opções de login. Verifique sua conexão e tente novamente.",
    ...
    "sign_up.legal": "Ao continuar, você concorda com os nossos termos e a política de privacidade.",
    "sign_up.error_email_taken": "Já existe uma conta com este e-mail.",
    "sign_up.password_too_short": "Use pelo menos {count} caracteres",
    "sign_up.verify_sent": "Conta criada — verifique sua caixa de entrada para confirmar seu e-mail e depois entre.",
    "password_reset.title": "Redefinir senha",
    "password_reset.subtitle": "Digite seu e-mail e enviaremos um link de redefinição.",
    "password_reset.email_label": "E-mail",
    "password_reset.submit": "Enviar link",
    "password_reset.back_to_sign_in": "Voltar ao login",
    "password_reset.sent": "Se existir uma conta para {email}, um link de redefinição está a caminho.",
    ...
    "paywall.cta": "Continuar",
    "paywall.restore": "Restaurar compras",
    "paywall.terms": "O pagamento será cobrado na sua conta. Cancele quando quiser.",
    ...
    "paywall.empty_body": "Não há assinaturas disponíveis no momento. Volte mais tarde.",
    "paywall.error_title": "Não foi possível conectar à loja",
    "paywall.error_body": "Não foi possível carregar as opções de assinatura. Verifique sua conexão e tente novamente.",
    "paywall.retry": "Tentar novamente",
    "paywall.purchase_pending": "Sua compra está aguardando aprovação. Ela será desbloqueada assim que confirmada.",
    "paywall.already_owned": "Você já tem esta assinatura — toque em Restaurar para revinculá-la.",
    "paywall.restore_none": "Nenhuma compra anterior foi encontrada para restaurar.",
    "paywall.restore_done": "Suas compras foram restauradas.",
    "paywall.restore_failed": "Não foi possível restaurar as compras: {error}",
    "error.email_not_verified": "Primeiro verifique seu e-mail — confira sua caixa de entrada.",
    ...
    "error.rate_limited": "Tentativas demais — aguarde um momento e tente novamente.",
    "error.provider_disabled": "Este método de login não está ativado para este app.",
    "error.provider_failed": "O login com o provedor falhou. Tente novamente.",
    "error.last_login_method": "Esta é sua única forma de entrar, por isso não pode ser removida.",
    ...
    "paywall.unavailable_web": "Indisponível para compra na web"
  },
  "it": {
    ...
    "sign_in.config_error_body": "Impossibile caricare le opzioni di accesso. Controlla la connessione e riprova.",
    ...
    "sign_up.legal": "Continuando accetti i nostri termini e la nostra informativa sulla privacy.",
    "sign_up.error_email_taken": "Esiste già un account con questa email.",
    "sign_up.password_too_short": "Usa almeno {count} caratteri",
    "sign_up.verify_sent": "Account creato — controlla la posta in arrivo per verificare il tuo indirizzo email, poi accedi.",
    "password_reset.title": "Reimposta password",
    "password_reset.subtitle": "Inserisci la tua email e ti invieremo un link per reimpostarla.",
    "password_reset.email_label": "Email",
    "password_reset.submit": "Invia link",
    "password_reset.back_to_sign_in": "Torna all'accesso",
    "password_reset.sent": "Se esiste un account per {email}, un link per reimpostare la password è in arrivo.",
    ...
    "paywall.terms": "Il pagamento verrà addebitato sul tuo account. Annulla quando vuoi.",
    ...
    "paywall.empty_body": "Al momento non ci sono abbonamenti disponibili. Torna più tardi.",
    "paywall.error_title": "Impossibile raggiungere lo store",
    "paywall.error_body": "Impossibile caricare le opzioni di abbonamento. Controlla la connessione e riprova.",
    "paywall.retry": "Riprova",
    "paywall.purchase_pending": "Il tuo acquisto è in attesa di approvazione. Verrà sbloccato una volta confermato.",
    "paywall.already_owned": "Possiedi già questo abbonamento — tocca Ripristina per ricollegarlo.",
    ...
    "error.email_not_verified": "Verifica prima il tuo indirizzo email — controlla la posta in arrivo.",
    "error.signup_closed": "Le registrazioni sono attualmente chiuse per questa app.",
    ...
    "error.provider_disabled": "Questo metodo di accesso non è abilitato per questa app.",
    "error.provider_failed": "Accesso con il provider non riuscito. Riprova.",
    "error.last_login_method": "È il tuo unico modo per accedere, quindi non può essere rimosso.",
    ...
    "paywall.unavailable_web": "Non disponibile per l'acquisto sul web"
  },
  "ja": {
    "sign_in.title": "ログイン",
    ...
    "paywall.unavailable_web": "ウェブでは購入できません"
  }
}
