import { MothEmailAlreadyExistsError, MothEmailNotVerifiedError, MothError, MothInvalidAccessTokenError, MothInvalidCredentialsError, MothInvalidEmailError, MothInvalidProviderTokenError, MothLastLoginMethodError, MothNetworkError, MothProviderDisabledError, MothRateLimitedError, MothSignUpClosedError, MothUserDisabledError, MothWeakPasswordError, } from '../core/errors.js';
/**
 ...
 */
export function friendlyMothErrorMessage(error, copy) {
    ...
    if (error instanceof MothWeakPasswordError)
