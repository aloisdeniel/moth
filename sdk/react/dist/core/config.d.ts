...
export declare const defaultConfigCacheTtlMs: number;
/** The TTL for `config`, applying the default. */
export declare function configCacheTtlMs(config: MothConfig): number;
/**
 ...
 */
export declare function currentLocaleOf(config: MothConfig): string;
