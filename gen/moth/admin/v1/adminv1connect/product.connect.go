...
const (
	...
	ProductServiceName = "moth.admin.v1.ProductService"
)
...
const (
	...
	// ListProducts RPC.
	ProductServiceListProductsProcedure = "/moth.admin.v1.ProductService/ListProducts"
	// ProductServiceGetProductProcedure is the fully-qualified name of the ProductService's GetProduct
	// RPC.
	ProductServiceGetProductProcedure = "/moth.admin.v1.ProductService/GetProduct"
	// ProductServiceCreateProductProcedure is the fully-qualified name of the ProductService's
	// CreateProduct RPC.
	ProductServiceCreateProductProcedure = "/moth.admin.v1.ProductService/CreateProduct"
	// ProductServiceUpdateProductProcedure is the fully-qualified name of the ProductService's
	// UpdateProduct RPC.
	ProductServiceUpdateProductProcedure = "/moth.admin.v1.ProductService/UpdateProduct"
	// ProductServiceDeleteProductProcedure is the fully-qualified name of the ProductService's
	// DeleteProduct RPC.
	ProductServiceDeleteProductProcedure = "/moth.admin.v1.ProductService/DeleteProduct"
)

// ProductServiceClient is a client for the moth.admin.v1.ProductService service.
...
// NewProductServiceClient constructs a client for the moth.admin.v1.ProductService service. By
...
func NewProductServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProductServiceClient {
	...
	productServiceMethods := v1.File_moth_admin_v1_product_proto.Services().ByName("ProductService").Methods()
...
// ListProducts calls moth.admin.v1.ProductService.ListProducts.
...
// GetProduct calls moth.admin.v1.ProductService.GetProduct.
...
// CreateProduct calls moth.admin.v1.ProductService.CreateProduct.
...
// UpdateProduct calls moth.admin.v1.ProductService.UpdateProduct.
...
// DeleteProduct calls moth.admin.v1.ProductService.DeleteProduct.
...
// ProductServiceHandler is an implementation of the moth.admin.v1.ProductService service.
...
func NewProductServiceHandler(svc ProductServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/moth.admin.v1.ProductService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProductServiceHandler) ListProducts(context.Context, *connect.Request[v1.ListProductsRequest]) (*connect.Response[v1.ListProductsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("moth.admin.v1.ProductService.ListProducts is not implemented"))
}
...
func (UnimplementedProductServiceHandler) GetProduct(context.Context, *connect.Request[v1.GetProductRequest]) (*connect.Response[v1.GetProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("moth.admin.v1.ProductService.GetProduct is not implemented"))
}
...
func (UnimplementedProductServiceHandler) CreateProduct(context.Context, *connect.Request[v1.CreateProductRequest]) (*connect.Response[v1.CreateProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("moth.admin.v1.ProductService.CreateProduct is not implemented"))
}
...
func (UnimplementedProductServiceHandler) UpdateProduct(context.Context, *connect.Request[v1.UpdateProductRequest]) (*connect.Response[v1.UpdateProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("moth.admin.v1.ProductService.UpdateProduct is not implemented"))
}
...
func (UnimplementedProductServiceHandler) DeleteProduct(context.Context, *connect.Request[v1.DeleteProductRequest]) (*connect.Response[v1.DeleteProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("moth.admin.v1.ProductService.DeleteProduct is not implemented"))
}
