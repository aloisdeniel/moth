...
const (
	...
	ProjectServiceName = "moth.admin.v1.ProjectService"
)
...
const (
	...
	// CreateProject RPC.
	ProjectServiceCreateProjectProcedure = "/moth.admin.v1.ProjectService/CreateProject"
	// ProjectServiceGetProjectProcedure is the fully-qualified name of the ProjectService's GetProject
	// RPC.
	ProjectServiceGetProjectProcedure = "/moth.admin.v1.ProjectService/GetProject"
	// ProjectServiceListProjectsProcedure is the fully-qualified name of the ProjectService's
	// ListProjects RPC.
	ProjectServiceListProjectsProcedure = "/moth.admin.v1.ProjectService/ListProjects"
	// ProjectServiceUpdateProjectProcedure is the fully-qualified name of the ProjectService's
	// UpdateProject RPC.
	ProjectServiceUpdateProjectProcedure = "/moth.admin.v1.ProjectService/UpdateProject"
...
func NewProjectServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProjectServiceClient {
	...
	projectServiceMethods := v1.File_moth_admin_v1_project_proto.Services().ByName("ProjectService").Methods()
...
// GetProject calls moth.admin.v1.ProjectService.GetProject.
...
// ListProjects calls moth.admin.v1.ProjectService.ListProjects.
...
// UpdateProject calls moth.admin.v1.ProjectService.UpdateProject.
...
// DeleteProject calls moth.admin.v1.ProjectService.DeleteProject.
...
func (UnimplementedProjectServiceHandler) CreateProject(context.Context, *connect.Request[v1.CreateProjectRequest]) (*connect.Response[v1.CreateProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("moth.admin.v1.ProjectService.CreateProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) GetProject(context.Context, *connect.Request[v1.GetProjectRequest]) (*connect.Response[v1.GetProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("moth.admin.v1.ProjectService.GetProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) ListProjects(context.Context, *connect.Request[v1.ListProjectsRequest]) (*connect.Response[v1.ListProjectsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("moth.admin.v1.ProjectService.ListProjects is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) UpdateProject(context.Context, *connect.Request[v1.UpdateProjectRequest]) (*connect.Response[v1.UpdateProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("moth.admin.v1.ProjectService.UpdateProject is not implemented"))
}
